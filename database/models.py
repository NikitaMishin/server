...
class PlotChallenge(models.Model):
    name = models.CharField(max_length=200)
    description = models.CharField(max_length=500)
    challenge_creator = models.ForeignKey(Person)
...
class Challenge(models.Model):
    ...
    category_challenge = models.ManyToManyField(CategoryChallenge, 'challenge_category')
    ...
    plot_challenge = models.ManyToManyField(PlotChallenge, 'plot_challenge')
    challenge_creator = models.ForeignKey(Person)
